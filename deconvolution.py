...
def richardson_lucy_deconvolution_3d_tv(image, psf, iterations=10, beta=0.5, tv_weight=0.1):
    """
    ...
    pad = psf.shape
    imagepadded = np.pad(image, ((pad[0]//2,pad[0]//2),(pad[1]//2,pad[1]//2),(pad[2]//2,pad[2]//2)),'edge')
    deconvolved = np.pad(deconvolved, ((pad[0]//2,pad[0]//2),(pad[1]//2,pad[1]//2),(pad[2]//2,pad[2]//2)),'edge')
    ...
    for i in range(iterations):
        ...
        try:
            ...
            deconvolved *= fftconvolve(ratio * np.exp(beta * laplacian), psf, mode='same')
            print("deconvolution start")
    ...
    deconvolved = deconvolved[pad[0]//2:-pad[0]//2, pad[1]//2:-pad[1]//2, pad[2]//2:-pad[2]//2]
    return deconvolved
